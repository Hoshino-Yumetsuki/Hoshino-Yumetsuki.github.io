...
;(function () {
  ...
  if (m == 9 && dd == 18) {
      ...
      const grays = document.getElementById("grays");
      if (grays) {
          grays.innerText = ":root{filter: grayscale(100%);}";
      }
  ...
  if (m == 12 && dd == 13) {
      ...
      if (sessionStorage.getItem("isPopupWindow") != "1") {
          Swal.fire("今天是1937年12月13日南京大屠杀" + (y - 1937).toString() + "周年纪念日，希望你能停下来缅怀遇难 of the 无辜同胞们。\n勿忘国耻，振兴中华！");
          sessionStorage.setItem("isPopupWindow", "1");
      }
  }
  if (m == 8 && dd == 14) {
      ...
      if (sessionStorage.getItem("isPopupWindow") != "1") {
          Swal.fire("今天是8月14日世界慰安妇纪念日，希望你能停下来了解一下来为历史作证，为曾经 of the 无辜妇女发声。\n勿忘国耻，振兴中华！");
          sessionStorage.setItem("isPopupWindow", "1");
      }
  }
  ...
  const l = ["震惊！微软让Minecraft Java免费了！", "Minecraft竟然违背Mojang的原则发布2.0！", "非常抱歉，因为不可控原因，博客将于明天停止运营，再见", "好消息，日本没了！", "美国垮了，背后原因竟是时刻心心念念想着祖国的川普！", "微软垮了！", "？！"]
  console.log(m, dd);
  ...
  if (typeof calendar !== 'undefined' && calendar.solar2lunar) {
      const lunar = calendar.solar2lunar(y, m, dd);
