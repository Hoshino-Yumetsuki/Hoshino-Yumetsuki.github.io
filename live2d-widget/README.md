...
```xml
<script src="https://cdn.smartcis.cn/gh/stevenjoezhang/live2d-widget@latest/autoload.js"></script>
```
...
| 选项 | 类型 | 默认值 | 说明 |
| - | - | - | - |
| `waifuPath` | `string` | `https://cdn.smartcis.cn/gh/stevenjoezhang/live2d-widget@latest/waifu-tips.json` | 看板娘资源路径，可自行修改 |
| `apiPath` | `string` | `https://live2d.fghrsh.net/api/` | API 路径，可选参数 |
| `cdnPath` | `string` | `https://cdn.smartcis.cn/gh/fghrsh/live2d_api/` | CDN 路径，可选参数 |
...
```xml
<script src="https://cdn.smartcis.cn/gh/username/live2d-widget@latest/autoload.js"></script>
```
