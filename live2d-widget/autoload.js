...
const live2d_path = "https://fastly.jsdelivr.net/npm/live2d-widgets@latest/dist/"
...
void (async () => {
  ...
  // Apply the overrides after the widget is inserted into the page.
  ...
  widgetStyle.textContent = `
    ...
    #live2d {
    transform: translateY(25px) scale(1.55);
  ...
  initWidget({
    ...
    cdnPath: "https://akilar-live2dapi.yumetsuki.moe/",
    // model_list.json 中 Nori 位于索引 12（从 0 开始）
    modelId: 12,
